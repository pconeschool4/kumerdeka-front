...
export default function Landing() {
  return (
    <div className="relative min-h-screen overflow-hidden bg-[#d9ecff] flex items-center justify-center p-4">
      ...
      <div className="relative z-10 w-full max-w-4xl rounded-[30px] border border-white/60 bg-white/40 p-8 shadow-[0_35px_100px_rgba(30,65,110,0.25)] backdrop-blur-xl sm:p-12">
        <div className="text-center">
          <div className="mx-auto mb-6 flex h-20 w-20 items-center justify-center rounded-2xl bg-white/60 text-[#1765a8] shadow-lg backdrop-blur-md">
          ...
          <div className="grid gap-6 md:grid-cols-2">
            ...
            <Link 
              to="/student/login"
              className="group relative flex flex-col items-center overflow-hidden rounded-3xl border border-white/50 bg-white/50 p-8 text-center shadow-lg backdrop-blur-md transition-all duration-300 hover:-translate-y-2 hover:bg-white/70 hover:shadow-xl"
            >
              <div className="mb-4 rounded-full bg-[#EAF4FF] p-4 text-[#4285D4] transition-transform duration-300 group-hover:scale-110">
                <BookOpen size={40} />
              </div>
